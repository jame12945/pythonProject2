...
def maxIndex_gd(a, index, n):
    ...
    return (k if int(a [ index ] [ 'points' ]) == int(a [ k ] [ 'points' ]) and int(a [ index ] [ 'gd' ]) < int(
        a [ k ] [ 'gd' ]) else index)
...
def checkpoints(lst, index=0):
    ...
    if lst [ index ] [ 'points' ] == lst [ index + 1 ] [ 'points' ] or lst [ index ] [ 'points' ] >= lst [ index + 1 ] [
        'points' ] or lst [ index ] [ 'points' ] == lst [ index + 1 ] [ 'points' ]:
        return True
    else:
        return False
